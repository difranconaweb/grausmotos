...
/*   SISTEMA DESENVOLVIDO POR FRANCO VIEIRA MORALES - INDAIATUBA 11SET18
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 23SET19
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 17NOV19
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 21MAR22
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 29DEZ22
     ...
     $moto       = strtoupper(trim($_GET['moto']));
...
// VERIFICA O TAMANHO DA STRING... SE FOR 11 ENTÃO É CPF E SE FOR 14 ENTÃO É CNPJ //
        ...
        {// ##  PRIMEIRO INSERE A MASCARA PARA O CPF ## //
                   ...
                   $check = mysql_query("SELECT cliPlaca FROM clientes WHERE cliPlaca LIKE '$placa' AND cliExcluir = 0");
                   ...
                   if(empty($register))
                   {
                       ...
                       {//  ESTE CAMPO FOI CRIADO PORQUE A MASCARA NÃO ACEITA CAMPO VÁZIO //
                        ...
                        //  ESTANDO TUDO CERTO E NÃO HAVENDO AINDA NENHUM REGISTRO COM A PLACA, SALVA O NOVO REGISTRO NA TABELA //
                            ...
                            cliCPF,cliRG,cliEmail,cliData,cliHora,cliMoto,cliPlaca,cliMarca,cliAno) VALUES ('$nome','$cep',$endereco','$numero','$bairro','$cidade','$telefone','$celular','$nascimento','$cpf','$inscricao','$email','$comentario','$data','$hora','$moto','$placa','$marca','$ano')");
                       ...
                       else
                       {
                           ...
                           //  ESTANDO TUDO CERTO E NÃO HAVENDO AINDA NENHUM REGISTRO COM A PLACA, SALVA O NOVO REGISTRO NA TABELA //
                            $sql = mysql_query("INSERT INTO clientes (cliNome,cliCep,cliEndereco,cliNumero,cliBairro,cliCidade,cliTelefone,cliCelular,cliDataNasc,
                            cliCPF,cliRG,cliEmail,cliData,cliHora,cliMoto,cliPlaca,cliMarca,cliAno) VALUES ('$nome','$cep','$endereco','$numero','$bairro','$cidade','$telefone','$celular','$nascimento','$cpf','$inscricao','$email','$data','$hora','$moto','$placa','$marca','$ano')");
                  ...
                  /* function Mask_inscricao($mask,$inscricao) 
                   ...
                   if(empty($register))
                   {
                                ...
                                {//  ESTE CAMPO FOI CRIADO PORQUE A MASCARA NÃO ACEITA CAMPO VÁZIO //
                                     ...
                                     $sql = mysql_query("INSERT INTO clientes (cliNome,cliCep,cliEndereco,cliNumero,cliBairro,cliCidade,cliTelefone,cliCelular,cliDataNasc,
                                    cliCNPJ,cliInscricao,cliEmail,cliData,cliHora,cliMoto,cliPlaca,cliMarca,cliAno) VALUES ('$nome','$cep','$endereco','$numero','$bairro','$cidade','$telefone','$celular','$nascimento','$cpf','$inscricao','$email','$data','$hora','$moto','$placa','$marca','$ano')");
...
// ### FECHADO MOMENTANEAMENTE                                   // $inscricao = Mask_inscricao('###.###.###.###');// 
        ...
        else
        {
                ...
                if(empty($register))
                {
                      ...
                      cliCNPJ,cliInscricao,cliRG,cliEmail,cliData,cliHora,cliMoto,cliPlaca,cliMarca,cliAno) VALUES ('$nome','$cep','$endereco','$numero','$bairro','$cidade','$telefone','$celular','$nascimento','000.000.000-00','00.000.000/0000-00','000.000.000.000','00.000.000-0','$email','$data','$hora','$moto','$placa','$marca','$ano')");
