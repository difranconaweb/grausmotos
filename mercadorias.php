...
/*   SISTEMA DESENVOLVIDO POR FRANCO VIEIRA MORALES - INDAIATUBA 10SET18
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 26SET18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 27SET18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 28SET18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 29SET18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - PIRACICABA 30SET18
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 1OOUT18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 13OUT18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 17OUT18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 19OUT18
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 08NOV18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 26NOV18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 20FEV19
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 21FEV19
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 09ABR22
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 18JAN23
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 28JAN23
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 04FEV23
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 08FEV23
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 02MAI23
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 23JUN23
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 24JUL23 - RES000101/13BR
                                                                   (19)3017-3460
                                                                   (19)99272-0159
                                                                   (19)99751-7645
       ...
       // VERIFICA SE HÁ CARGA NO CAMPO DE PESQUISA //
        ...
        //    mysql_query("UPDATE ponteiro SET ponPesquisa = '' WHERE ponResponsavel LIKE '$usuario'");
            ...
            {// SE A PESQUISA VIER VÁZIA; ENTRA NESTE BLOCO //
                   $st = mysql_query("SELECT merCodigo, merCodigoProduto, merMarca, merMercadoria, merNCM, merCST, merCEST, merQuantidade,merUnidade, merCompra, merFrete, merEncargos, merPercentual, merVenda, merPrecoCompraUnid, merPrecoVendaUnid, merLucroFinal, merPrateleira, merGrupo, gruNome FROM mercadorias LEFT JOIN grupo ON mercadorias.merGrupo = grupo.gruCodigo WHERE merExcluir = 0");
            ...
            {
                   $st = mysql_query("SELECT merCodigo, merCodigoProduto, merMarca, merMercadoria, merNCM, merCST, merCEST, merQuantidade, merUnidade, merCompra, merFrete, merEncargos, merPercentual, merVenda, merPrecoCompraUnid, merPrecoVendaUnid, merLucroFinal, merPrateleira, merGrupo, gruNome FROM mercadorias LEFT JOIN grupo ON mercadorias.merGrupo = grupo.gruCodigo WHERE merExcluir = 0 AND merCodigoProduto = '$objPesquisa'");
                   while($mer = mysql_fetch_array($st))
                   {
                       $id            = $mer['merCodigo'];
                       $codigoProduto = $mer['merCodigoProduto'];
  ...
  <header class="header-bar d-flex d-lg-block align-items-center" data-aos="fade-left">
    ...
    <div class="main-menu">
      <ul class="js-clone-nav">
        ...
        <li><a href="http://www.grausmotos.com.br/ponteiro.php?sender=12">relatório</a></li>
           ...
           <hr>
              ...
              <div class="row">
                ...
                <!--  ###  INICIO DE FORMULÁRIO DE CADASTRO DE USUÁRIO  ###  -->
                 ...
                 <input type="hidden" name="name_group" id="name_group" value=""><!--  ESTA VARIÁVEL É PARA ENVIAR O NOME DO GRUPO NOVO DIGITADO -->
                 <input type="hidden" name="id" id="id" value="<?php print $id; ?>"><!--  ESTA VARIÁVEL É PARA ENVIAR O ID DA PEÇA NA COLUNA DE AUTO INCREMENTO -->
                 
                        <div class="row form-group">
                          <div class="col-md-12">
                            <label class="text-white" for="registro">QUANT. REGISTROS..: &ensp;<?php  $obj =  mysql_query("SELECT merCodigo FROM mercadorias WHERE merExcluir = 0"); 
          $soma =  mysql_num_rows($obj); print $soma;?></label> 
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="grupo" class="form-control" onChange="criar_groupo()">
                        ...
                        <div class="row form-group">
                            <div class="col-md-4 mb-3 mb-md-0">
                                <label class="text-white" for="ncm">NCM</label>
                                <input type="text" id="ncm"  class="form-control" value="<?php print $ncm; ?>">
                            </div>
                            <div class="col-md-4 mb-3 mb-md-0">
                                <label class="text-white" for="cest">CEST</label>
                                <input type="text" id="cest"  class="form-control" value="<?php print $cest; ?>">
                            </div>
                            <div class="col-md-4 mb-3 mb-md-0">
                                <label class="text-white" for="cst">CST</label>
                                <input type="text" id="cst"  class="form-control" value="<?php print $cst; ?>">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                           ...
                           <div class="col-md-4 mb-3 mb-md-0">
                                <label class="text-white" for="unidade">UNIDADE</label>
                                <input type="text" id="unidade" class="form-control" value="<?php print $unidade ?>">
                           </div>
                           <div class="col-md-4 mb-3 mb-md-0">
                        ...
                        <div class="row form-group">
                           <div class="col-md-4 mb-3 mb-md-0">
                              <label class="text-white" for="prateleira">PRATELEIRA</label>
                              <input type="text" id="prateleira" class="form-control" value="<?php print utf8_encode($prateleira); ?>">
                           </div>
                           <div class="col-md-4 mb-3 mb-md-0">
...
<!-- ####  FINAL DE FOMULÁRIO DE CADASTRO DE MERCADORIA #### -->
                        ...
                        <ul class="copyright">
                           <li>&copy;<?php print Date('Y') ?>. GRAUS MOTOS -  Mercadorias.</li>
                        </ul></br>

                        <div class="row form-group">
                          <div class="col-md-12">
                            <input type="button" id="mer_gravar" value="Gravar" class="btn btn-primary btn-md text-white"  onclick="salva_mercadoria()"/>
