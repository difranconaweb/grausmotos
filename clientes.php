<?php
/*   SISTEMA DESENVOLVIDO POR FRANCO VIEIRA MORALES - INDAIATUBA 11SET18
     SISTEMA DESARROLLADO POR FRANCO VIEIRA MORALES - INDAIATUBA 11SET18
     SYSTEM  DEVELOPED    BY  FRANCO VIEIRA MORALES - INDAIATUBA 11SET18
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 03OUT18
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 27OUT18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 28OUT18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 03NOV18
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 15MAI19
     SISTEMA ATUALIZADO >>>
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 14SET19
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 15SET19
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 16SET19
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 18SET19
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 21SET19
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 22SET19
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 24SET19
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 04NOV19
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 12JAN20
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 08MAR21
     ...
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 23MAR22
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 11ABR22
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 08MAI22
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 29MAI22
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 02JUN22
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 04JUN22
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 10JUN22
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 08SET22
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 10JUN23
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 17AGO23 - RES000101/13BR
                                                                   (19)3017-3460
                                                                   (19)99272-0159
                                                                   (19)99751-7645


     PÁGINA  PARA REGISTRAR NOVO CLIENTE - GRAUS MOTOS  */
     session_start();
     ...
     else
     {
          // VERIFICA SE HÁ CARGA NO CAMPO DE PESQUISA //
            ...
            {
                  $sql = mysql_query("SELECT * FROM  clientes WHERE cliCodigo = '$objPesquisa' OR cliPlaca = '$objPesquisa' AND cliExcluir = 0");
                  while($obj = mysql_fetch_array($sql))
...
<html lang="en">
  <head>
    ...
    <!-- FAVICON -->
    <link rel="icon" type="image/png" href="img/motoca.icon">
  ...
  <header class="header-bar d-flex d-lg-block align-items-center" data-aos="fade-left">
    ...
    <div class="main-menu">
      <ul class="js-clone-nav">
        ...
        <li><a href="http://www.grausmotos.com.br/ponteiro.php?sender=10">relatório</a></li>
                  ...
                  <input type="hidden" name="user" id="user" value="<?php  print $usuario; ?>"><!--  ESTA VARIÁVEL É PARA ENVIAR O NOME DO USUÁRIO -->
                        ...
                        <div class="row form-group">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <input type="text" id="cpf" size="18" maxlength="18" class="form-control" value="<?php print $geralDoc ?>"  onblur="validando()">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <label class="text-white" for="moto">MOTO</label>
                                <input type="text" id="moto" size="20" maxlength="20" class="form-control" value="<?php print $moto ?>">
                            </div>
                            <div class="col-md-6">
                        ...
                        <ul class="copyright">
                           <li>&copy;<?php print Date('Y') ?>. GRAUS MOTOS -  Clientes.</li>
                        </ul></br>
                        ...
                        <div class="row form-group">
                          <div class="col-md-12">
                            ...
                            <input type="button" id="delete" name="delete" value="Excluir" class="btn btn-primary btn-md text-white" onclick="excluir_cliente()"/>
