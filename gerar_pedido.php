<?php
/*   SISTEMA DESENVOLVIDO POR FRANCO VIEIRA MORALES - INDAIATUBA 06NOV21
     SISTEMA DESARROLLADO POR FRANCO VIEIRA MORALES - INDAIATUBA 06NOV21
     SYSTEM  DEVELOPED    BY  FRANCO VIEIRA MORALES - INDAIATUBA 06NOV21

     
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 07NOV21
    ...
    /* ################################################################################################ */
        ...
        while($_obj = mysql_fetch_array($_obj))
        {
            ...
            if($merQuantidade != 0)
            {
              ...
              // ### APAGA O ORCAMENTO DA TABELA DEDICADA ### //
